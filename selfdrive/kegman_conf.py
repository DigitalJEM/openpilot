  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      if "battPercOff" not in self.config:
        self.config.update({"battPercOff":"15"})
      ...
      self.config = {"cameraOffset":"0.05", "lastTrMode":"1", "battChargeMin":"99", "battChargeMax":"100", \
                     "wheelTouchSeconds":"600", "accelerationMode":"1","battPercOff":"15", "carVoltageMinEonShutdown":"11800", \
